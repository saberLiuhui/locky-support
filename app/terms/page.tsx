...
export const termsDocument = {
      ...
      sections: [
        ...
        },
        {
          title: "安全恢复",
          paragraphs: [
            <>停止保护、暂停规则、恢复所选 App、权限修复和“恢复所有保护”不会因为会员到期而被付费墙阻止。若系统授权异常，你仍可按照支持页面说明在 iOS 设置中撤销相关权限。</>,
          ],
        },
        {
          title: "会员与付款",
          paragraphs: [
            <>部分高级功能需要购买 VIP。实际商品、价格、试用资格、续订状态和退款结果以 App Store 购买确认页及 Apple 账户为准。自动续订和终身 VIP 的具体约定见《订阅协议》。</>,
          ],
        },
        {
          title: "服务变更与终止",
          paragraphs: [
            <>我们可能因功能调整、Apple 平台规则、法律要求或安全原因更新、暂停或停止部分功能。对于已购买的自动续订 VIP，我们会按照 Apple 的要求保障当前有效周期内已购买的权益；具体购买、取消和退款规则见《订阅协议》。</>,
          ],
        },
        {
          title: "合理使用与责任",
