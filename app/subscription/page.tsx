...
export const metadata: Metadata = {
  title: "订阅协议",
  description: "Locky 会员免费试用、自动续订、终身 VIP、取消及恢复购买说明。",
};
      ...
      sections: [
        {
          title: "会员商品",
          paragraphs: [
            <>Locky 计划提供周 VIP、年 VIP 和终身 VIP。周 VIP 与年 VIP 为自动续订订阅；终身 VIP 为一次性购买的非消耗型项目，不会自动续订。</>,
            <>中国大陆区计划价格为周 VIP ¥28、年 VIP ¥88、终身 VIP ¥128。实际销售价格、币种、税费和可用商品以 App Store 购买确认页面为准，网页展示不构成价格保证。</>,
        ...
        },
        {
          title: "三天免费试用",
          paragraphs: [
            <>周 VIP 计划提供三天免费试用，但仅在 App Store 判断当前 Apple 账户符合资格且购买确认页明确展示试用时有效。试用资格由 Apple 决定，我们无法手动赠送、恢复或重复开通试用。</>,
            <>试用结束后，周 VIP 会按购买确认页显示的价格自动续订，除非你在试用结束前通过 Apple 订阅管理取消。删除 Locky 不会取消订阅。</>,
          ],
        },
        {
          title: "扣款与自动续订",
        ...
        },
        {
          title: "终身 VIP",
          paragraphs: [
            <>终身 VIP 指对当前 Locky iOS 应用的一次性购买权益，在应用持续提供且符合 Apple 平台规则期间解锁相应会员功能。它不等同于开发者其他应用、未来独立产品、安卓版本或第三方服务的永久权益。</>,
          ],
        },
        {
          title: "恢复购买与设备变更",
